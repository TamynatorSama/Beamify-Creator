      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(12),
              image: DecorationImage(
                  image: NetworkImage('https://beamify.stream/api/storage'+data.channelImage), fit: BoxFit.cover)),
        ),
        const SizedBox(
          height: 10,
        ),
  ...
  Widget _buildUserInfo(UserModel? model) => Row(
        children: [
          Container(
            ...
            child: model?.avatar != null ? Image.network(model!.avatar!,errorBuilder: (context, error, stackTrace) => SvgPicture.string("""<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><circle cx="12" cy="6" r="4" fill="#163C86"/><path fill="#163C86" d="M20 17.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S7.582 13 12 13s8 2.015 8 4.5" opacity="0.5"/></svg>""",theme: const SvgTheme(currentColor: AppTheme.btnColor),),) : SvgPicture.string("""<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><circle cx="12" cy="6" r="4" fill="#163C86"/><path fill="#163C86" d="M20 17.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S7.582 13 12 13s8 2.015 8 4.5" opacity="0.5"/></svg>""",theme: const SvgTheme(currentColor: AppTheme.btnColor),),
          ),
          const SizedBox(
            width: 20,
          ),
